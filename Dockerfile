...
RUN apk --no-cache add php7 php7-fpm php7-mysqli php7-json php7-openssl php7-curl \
    php7-zlib php7-xml php7-phar php7-dom php7-xmlreader php7-ctype php7-session \
    php7-mbstring php7-gd php7-exif php7-fileinfo php7-pecl-imagick php7-zip php7-iconv supervisor curl
